...
class ClothingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clothing" do
    assert_difference('Clothing.count') do
      post clothings_url, params: { clothing: { name: @clothing.name, overview: @clothing.overview } }
    end
  ...
  test "should update clothing" do
    patch clothing_url(@clothing), params: { clothing: { name: @clothing.name, overview: @clothing.overview } }
